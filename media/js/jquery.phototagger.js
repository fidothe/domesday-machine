...
(function( window, $ ){
	...
	PhotoTagger.prototype = {
		...
		teardownPendingTagCreation: function(){
			...
			if (this.isPendingTagSizeValid()){
				...
				var message = prompt( "Enter structidx:", "" );
				function trim(s){ 
				...
				if (message != '' && message != null) {
					...
					if (isInteger(message)){
					    ...
					    alert("Please enter an integer value. This structidx has not been saved.");
					}
				}
			} else {
	...
	$.fn.photoTagger.defaultOptions = {
		...
		ajaxFailMessage: "Sorry, there was a problem with the API. This transaction will not be saved.",
